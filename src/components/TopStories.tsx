  ...
  return (
    <section className='wrapper my-8'>
      ...
      <div className='grid-cols-1 gap-4 [grid-template-areas:"first"_"second"_"third"_"fourth"_"fifth"] last:grid  sm:grid-cols-2 sm:[grid-template-areas:"first_first"_"second_third"_"fourth_fifth"] md:gap-6 lg:grid-cols-4 lg:[grid-template-areas:"first_first_second_third"_"first_first_fourth_fifth"]'>
        <div className='relative flex aspect-[3/2] max-h-[22rem] w-full bg-navBg [grid-area:first] lg:max-h-[25rem]'>
          <Image
        ...
        <div className='relative flex aspect-[4/2] w-full bg-navBg [grid-area:second] lg:aspect-auto'>
          <Image
            className='object-cover'
        ...
        <div className='relative flex aspect-[4/2] w-full bg-navBg [grid-area:third] lg:aspect-auto'>
          <Image
            className='object-cover'
        ...
        <div className='relative flex aspect-[4/2] w-full bg-navBg [grid-area:fourth] lg:aspect-auto'>
          <Image
            className='object-cover'
        ...
        <div className='relative flex aspect-[4/2] w-full bg-navBg [grid-area:fifth] lg:aspect-auto'>
          <Image
            className='object-cover'
